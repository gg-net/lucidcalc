...
public class JExcelReaderTest {
    ...
    public static class SampleBean {
        ...
        public boolean equals(Object obj) {
            ...
            if ( !Objects.equals(this.f2, other.f2) && (this.f2 == null || !this.f2.equals(other.f2)) ) return false;
            if ( !Objects.equals(this.f3, other.f3) && (this.f3 == null || !this.f3.equals(other.f3)) ) return false;
